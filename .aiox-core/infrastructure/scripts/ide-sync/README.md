...
- `.cursor/agents/` (Cursor — condensed rules format)
- `.antigravity/agents/` (AntiGravity — condensed rules format; root of the IDE folder)
- `.windsurf/rules/AIOX/agents/` (Windsurf / Cascade)
...
| Windsurf    | Cascade (frontmatter)   | `.md`     |
...
└── transformers/
    ...
    └── windsurf.js          # Windsurf / Cascade format
```
