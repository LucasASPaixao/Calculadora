...
function getDefaultOptions() {
  ...
  return {
    ...
    skillsDir: path.join(projectRoot, '.aiox-core', 'ide', 'codex', 'skills'),
...
function validateCodexIntegration(options = {}) {
  ...
  const resolved = {
    ...
    skillsDir: options.skillsDir || path.join(projectRoot, '.aiox-core', 'ide', 'codex', 'skills'),
  ...
  // Skills are now sourced from .aiox-core/ide/codex/skills/ — one skill per agent expected
