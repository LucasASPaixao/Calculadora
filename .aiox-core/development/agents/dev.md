  ...
  tlc_skill_integration:
    ...
    capabilities:
      - name: implement-protocol
        ...
        behavior: |
          Before code: state assumptions, files to touch, success criteria. One task at a time; verify; atomic commits per Conventional Commits 1.0.0.
      - name: quick-mode
        triggers:
          - quick fix
          - quick task
          - bug fix
        reference: references/quick-mode.md
        behavior: |
          Max 3 files, max 1h, no new dependencies without escalation. Pre-check with user approval.
