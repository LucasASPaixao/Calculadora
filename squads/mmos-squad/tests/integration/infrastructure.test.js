...
jest.mock('../../../../.aiox-core/infrastructure/services/clickup', () => ({
...
jest.mock('../../../../.aiox-core/infrastructure/services/google-drive', () => ({
...
jest.mock('../../../../.aiox-core/infrastructure/services/file-service', () => ({
...
jest.mock('../../../../.aiox-core/infrastructure/services/etl', () => ({
...
describe('Infrastructure Service Tests', () => {
  ...
  describe('ClickUp Service', () => {
    ...
    beforeEach(() => {
      clickup = require('../../../../.aiox-core/infrastructure/services/clickup');
    });
  ...
  describe('Google Drive Service', () => {
    ...
    beforeEach(() => {
      const drive = require('../../../../.aiox-core/infrastructure/services/google-drive');
  ...
  describe('File Service', () => {
    ...
    beforeEach(() => {
      const fs = require('../../../../.aiox-core/infrastructure/services/file-service');
  ...
  describe('ETL Service', () => {
    ...
    beforeEach(() => {
      const etl = require('../../../../.aiox-core/infrastructure/services/etl');
  ...
  describe('Service Error Handling', () => {
    it('should handle ClickUp API errors gracefully', async () => {
      const clickup = require('../../../../.aiox-core/infrastructure/services/clickup');
    ...
    it('should handle Google Drive errors gracefully', async () => {
      const { GoogleDriveService } = require('../../../../.aiox-core/infrastructure/services/google-drive');
    ...
    it('should handle File Service errors gracefully', async () => {
      const { FileService } = require('../../../../.aiox-core/infrastructure/services/file-service');
    ...
    it('should handle ETL Service errors gracefully', async () => {
      const { ETLService } = require('../../../../.aiox-core/infrastructure/services/etl');
